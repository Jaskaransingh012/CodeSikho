...
export default function SignUpPage() {
    return (
        <div className="min-h-screen grid w-full items-center bg-white px-4 font-mono text-sm text-white">
            <SignUp.Root>
                <SignUp.Step
                    name="start"
                ...
                >
                    <header className="text-center flex flex-col items-center">
                        ...
                        <h1 className="mt-3 text-3xl font-bold tracking-wide text-black uppercase font-game ">

                            Sign in to CodeSikho
                    ...
                    <div className="space-y-4">
                        <Clerk.Field name="emailAddress" className="space-y-1">
                            ...
                            <Clerk.Input
                                type="email"
                                required
                                className="w-full px-3 py-2 border-2 border-black shadow-[3px_3px_0_0_#000] text-black outline-none focus:border-yellow-400"
                            />
                        ...
                        <Clerk.Field name="password" className="space-y-1">
                            ...
                            <Clerk.Input
                                type="password"
                                required
                                className="w-full px-3 py-2  border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-yellow-400 text-black"
                            />
                            <Clerk.FieldError className="text-sm text-red-500" />
                        </Clerk.Field>
                    </div>
                ...
                <SignUp.Step
                    name="verifications"
                    className="mx-auto w-full sm:w-96 space-y-6 px-4 py-8 border-4 border-black shadow-[8px_8px_0_0_#000]"
                >
                    ...
                    <SignUp.Strategy name="email_code">
                        <Clerk.Field name="code" className="space-y-1">
                            ...
                            <Clerk.Input type="otp" required className="w-full px-3 py-2  border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-yellow-400 text-black" />
                            <Clerk.FieldError className="text-sm text-red-500" />
                        </Clerk.Field>
                        <SignUp.Action submit className="w-full px-4 py-2 bg-yellow-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase">
                            Verify
                    ...
                    <p className="text-center text-xs text-black">
                        Already have an account?{' '}
                        <Clerk.Link navigate="sign-in" className="font-bold underline underline-offset-2">
                            Sign in
                        </Clerk.Link>
                    </p>
                </SignUp.Step>
